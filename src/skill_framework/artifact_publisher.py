...
class S3Backend:
    ...
    def __init__(
        ...
        self.s3 = boto3.client("s3", region_name=region or os.getenv("AWS_REGION", "us-east-1"))
...
class ArtifactPublisher:
    ...
    def publish_many(self, file_paths: list[Path | str], zip_name: str = "artifacts.zip") -> Artifact:
...
def publish_artifacts(file_paths: list[Path | str], zip_name: str = "artifacts.zip") -> Artifact:
